...
public class RoundLinearLayout extends LinearLayout {
    ...
    private void initStyles(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RoundLinearLayout, defStyleAttr, 0);
        isSelector = typedArray.getBoolean(R.styleable.RoundLinearLayout_is_selector, false);
        leftTopRadius = typedArray.getDimensionPixelSize(R.styleable.RoundLinearLayout_left_top_radius, 0);
        leftBottomRadius = typedArray.getDimensionPixelSize(R.styleable.RoundLinearLayout_left_bottom_radius, 0);
        rightTopRadius = typedArray.getDimensionPixelSize(R.styleable.RoundLinearLayout_right_top_radius, 0);
        rightBottomRadius = typedArray.getDimensionPixelSize(R.styleable.RoundLinearLayout_right_bottom_radius, 0);
        radius = typedArray.getDimensionPixelSize(R.styleable.RoundLinearLayout_radius, 0);
        noColor = typedArray.getResourceId(R.styleable.RoundLinearLayout_no_color, R.color.white);
        noStrokeColor = typedArray.getResourceId(R.styleable.RoundLinearLayout_no_stroke_color, R.color.transparent);
        yesColor = typedArray.getResourceId(R.styleable.RoundLinearLayout_yes_color, R.color.white);
        yesStrokeColor = typedArray.getResourceId(R.styleable.RoundLinearLayout_yes_stroke_color, R.color.transparent);
        ...
        lineStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.RoundLinearLayout_stroke_line_width, 0);
        typedArray.recycle();
    }
